            ...
            SizedBox(
                ...
                child: TextButton(
                  ...
                  style: TextButton.styleFrom(
                    backgroundColor: ispayactived
                        ? const Color(0xFFFFDC60)
                        : Color.fromARGB(255, 99, 97, 93),
                    shape: RoundedRectangleBorder(
                      side: const BorderSide(
                          width: 0.50, color: Color(0xFF488AD2)),
        ...
        child: Column(
          ...
          children: [
            ...
            PaymentContainer(
                img: creditcard,
                text: "Card",
                text2: "Visa, Mastercard, RuPay",
                isChecked: _isCardChecked,
                ontap: () {
                  print("Card");
                  setState(() {
                    ispayactived = true;
            ...
            PaymentContainer(
                img: Iconwallet,
                text: "NetBanking",
                text2: "All Indian banks",
                isChecked: _isnetBChecked,
                ontap: () {
                  print("NetBanking");
                  setState(() {
                    ispayactived = true;
